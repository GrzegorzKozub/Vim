...
let s:p.insert.left     = [ [ s:base03, s:blue ], s:p.normal.left[1] ]
let s:p.replace.left    = [ [ s:base03, s:orange ], s:p.normal.left[1] ]
let s:p.visual.left     = [ [ s:base03, s:green ], s:p.normal.left[1] ]
