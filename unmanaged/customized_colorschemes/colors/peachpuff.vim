...
hi VertSplit term=reverse cterm=reverse gui=bold guifg=White guibg=Gray45 ctermbg=bg
...
hi Error term=reverse cterm=bold ctermfg=DarkRed ctermbg=bg gui=bold guifg=White guibg=Red
hi Todo term=standout ctermfg=DarkYellow ctermbg=bg guifg=Blue guibg=Yellow
